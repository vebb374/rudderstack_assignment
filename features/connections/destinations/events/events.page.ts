...
export class EventsPage {
    ...
    constructor(page: Page) {
        ...
        this.deliveredEventsCount = page
            .locator("text=Delivered")
            .locator("..")
            .getByRole("heading", { level: 2 });
        this.failedEventsCount = page
            .locator("text=Failed")
            .locator("..")
            .getByRole("heading", { level: 2 });
        this.failureRatePercentage = page
            .locator("text=Failure rate")
            .locator("..")
            .getByRole("heading", { level: 2 });
        this.eventsTrendChart = page.locator("text=Events Trend").locator("..");
        this.refreshButton = page.getByRole("button", { name: "Refresh" });
        this.metricsLatencyAlert = page.getByText(
            "Metrics may not be real time due to reporting latency"
        );
