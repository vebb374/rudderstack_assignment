...
Given('the user navigates to the webhook destination', async function (this: ICustomWorld) {
  ...
  this.destinationDetailsPage = new DestinationDetailsPage(this.page!);
...
When('the user clicks on the {string} button', async function (this: ICustomWorld, buttonName: string) {
...
Then('the user should see the destination name {string}', async function (this: ICustomWorld, expectedName: string) {
  const actualName = await this.destinationDetailsPage!.getDestinationName();
  expect(actualName).toBe(expectedName);
});

Then('the user should see the destination type {string}', async function (this: ICustomWorld, expectedType: string) {
  await expect(this.destinationDetailsPage!.destinationType).toBeVisible();
});

Then('the user should see the destination status as {string}', async function (this: ICustomWorld, expectedStatus: string) {
...
Then('the user should see the connected source {string}', async function (this: ICustomWorld, expectedSource: string) {
